/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 0e0dc7fbb48e0639e257478ae74a7566)
// Runtime types generated with workerd@1.20260921.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	SETTINGS_ADMIN_KEY: string;
	ProjectAgent: DurableObjectNamespace<import("./src/server").ProjectAgent>;
	...
	PLAYBOOK_WORKFLOW: Workflow<Parameters<import("./src/server").PlaybookWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ProjectAgent" | "ChatAgent" | "SettingsAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SETTINGS_ADMIN_KEY">> {}
}
