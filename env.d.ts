/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: c59d759e86b01601b7b9dda920ae135f)
// Runtime types generated with workerd@1.20260721.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	SupplyChainAgent: DurableObjectNamespace<import("./src/server").SupplyChainAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "SupplyChainAgent";
	}
