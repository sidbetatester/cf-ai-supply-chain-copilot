/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: c441e935d5c69aed875bd97198dcadd7)
// Runtime types generated with workerd@1.20260923.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI_RATE_LIMITER: RateLimit;
	UNLOCK_RATE_LIMITER: RateLimit;
	AI: Ai;
	AI_DAILY_NEURON_BUDGET: "9000";
	AI_CLIENT_DAILY_SHARE: "0.2";
	SETTINGS_ADMIN_KEY: string;
	SettingsAgent: DurableObjectNamespace<import("./src/server").SettingsAgent>;
	UsageLimiter: DurableObjectNamespace<import("./src/server").UsageLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "SettingsAgent" | "UsageLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_DAILY_NEURON_BUDGET" | "AI_CLIENT_DAILY_SHARE" | "SETTINGS_ADMIN_KEY">> {}
}
