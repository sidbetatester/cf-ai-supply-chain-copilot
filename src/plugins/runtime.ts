// Turns the plugin registry into what the LLM sees: the toolset and the
// plugin-derived part of the system prompt.
import { tool, type ToolSet } from "ai";
import { z } from "zod";
import type { ToolContext } from "./define";
import { listPlugins, listSkills, listTools } from "./registry";
